...
def test_recover_refreshes_power_and_voltage_entities() -> None:
    home_assistant = MagicMock(spec=HomeAssistantManager)
    ...
    home_assistant.trigger_service.assert_any_call("homeassistant", "update_entity", entity_id="sensor.power")
    home_assistant.trigger_service.assert_any_call("homeassistant", "update_entity", entity_id="sensor.voltage")
